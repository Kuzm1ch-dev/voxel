...
use crate::engine::{UIRenderer, Vertex, render::texture_manager::TextureManager};
...
impl<'window> Renderer<'window> {
    ...
    pub fn render(&mut self) -> Result<(), wgpu::SurfaceError> {
        ...
        // Update UI buffers
        self.ui.update_buffers(&self.device);
    ...
    pub fn get_screen_width(&mut self) -> f32 {
        return self.config.width as f32;
    }

    pub fn get_screen_height(&mut self) -> f32 {
        return self.config.height as f32;
    }

    pub fn get_screen_size(&mut self) -> Vec2 {
        return Vec2::new(self.get_screen_width(), self.get_screen_height());
    }
